...
module.exports = async (req, res) => {
  ...
  const responsePayload = {
    ...
    paymentName: order.paymentName || order.method || null,
    ...
    payCode: order.payCode || order.vaNumber || null,
    vaNumber: order.vaNumber || order.payCode || null,
    checkoutUrl: order.checkoutUrl || null,
    qrUrl: order.qrUrl || null,
    qrString: order.qrString || null,
    expiresAt: order.expiresAt || null,
    instructions: order.instructions || null,
    ticketType: order.ticketType || "regular",
    eventTitle: order.eventTitle || null,
    eventId: order.eventId || null,
    amountForTripay: order.amountForTripay ?? null,
    tripayFee: order.tripayFee ?? null,
    platformTax: order.platformTax ?? null,
